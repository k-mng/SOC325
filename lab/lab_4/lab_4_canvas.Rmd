...
* DO **NOT** code a bunch and then *knit* -- This will almost assuredly not work and crash!
...
Our class average sleep time is `r round(summarize2$average, 2)` minutes, or `r round((summarize2$average)/60, 2)` hours. The average sleep time for all of Seattle Metro is `r round(summarize3$average, 2)` minutes, or `r round((summarize3$average)/60, 2)` hours. 
...
*Question*: What are the average hours slept for people who are working vs. people who aren't?
