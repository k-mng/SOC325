...
Our class average sleep time is `r summarize2$average` minutes, or `r (summarize2$average)/60` hours. The average sleep time for all of Seattle Metro is `r summarize3$average` minutes, or `r (summarize3$average)/60` hours. 
